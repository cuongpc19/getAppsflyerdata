...
from .serializers import CampaignOnlySerializer # <-- Import serializer mới
...
class GetCampaignByAppsflyerIDAPIView(APIView):
    ...
    def get(self, request, appsflyer_id):
        ...
        appflyer_data = get_object_or_404(Install_Data, appsflyerID=appsflyer_id)

        # 2. Chuyển đổi đối tượng bằng CampaignOnlySerializer
        serializer = CampaignOnlySerializer(appflyer_data)
